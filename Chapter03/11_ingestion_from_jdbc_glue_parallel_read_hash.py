# Chapter 03
# Code Snippet 11 - Ingest data from JDBC - Glue ETL JDBC Parallel reads using hash partitioning.
...
# Here, we are using hashexpressions and hashpartitions to instruct AWS Glue ETL to parallelize JDBC reads using hashing method.
mysql_options = {
