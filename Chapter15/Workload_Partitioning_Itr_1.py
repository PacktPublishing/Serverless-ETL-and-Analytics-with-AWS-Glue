# Sample Script demonstrating Simple Join operation without using workload partitoning technique.
...
tripsfactDyf = glueContext.create_dynamic_frame.from_catalog(database = "trips_fact_data", table_name = "trips_fact_data", transformation_ctx = "datasource0")

paymentDimDyf = glueContext.create_dynamic_frame.from_catalog(database = "workload_partitioning", table_name = "payments_dim_data", transformation_ctx = "datasource0")
