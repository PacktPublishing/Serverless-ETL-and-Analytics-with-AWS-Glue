# Iteration 3 : Sample Script demonstrating Simple Join operation with workload partitoning technique with tighter bounds.
...
tripsfactDyf = glueContext.create_dynamic_frame.from_catalog(database = "trips_fact_data", table_name = "trips_fact_data", transformation_ctx = "datasource0",additional_options = {"boundedFiles" : "45000"})

paymentDimDyf = glueContext.create_dynamic_frame.from_catalog(database = "workload_partitioning", table_name = "payments_dim_data", transformation_ctx = "datasource0", additional_options = {"boundedFiles" : "45000"})
